...
@commands.command(help="Say hello to the sender")
async def hello(ctx):
    await ctx.send(f"Hello {ctx.author.mention}")

@commands.command(help="Answer to Stalin")
...
@commands.command(help="Dm a certain user")
@commands.has_role(used_role)
...
@commands.command(help="Reply to the sender")
async def reply(ctx,*,msg):
    await ctx.reply("This is a relpy")

@commands.command(help="Create a custom poll")
...
@commands.command(name="wordlb", help="Count a certain word in specified channels")
...
@commands.command(help="spam a word a specified amount of times", hidden=True)
@commands.has_role(used_role)
...
@commands.command(help="Find a specific message in given channel")
...
@commands.command(help="mention a certain user")
...
async def setup(bot):
    ...
    bot.add_command(Commie)
    bot.add_command(dm)
    bot.add_command(reply)
    bot.add_command(poll)
    bot.add_command(word_leaderboard)
